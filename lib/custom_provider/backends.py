...
Wrap existing backends (OpenAI/Gemini etc.) as custom providers, overriding name and model properties.
"""
...
class CustomTextBackend:
    """Custom provider text generation backend wrapper class."""
...
class CustomImageBackend:
    """Custom provider image generation backend wrapper class."""
...
class CustomVideoBackend:
    """Custom provider video generation backend wrapper class."""
