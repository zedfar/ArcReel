...
const SKILL_META_FALLBACK: Record<string, { label: string; icon: LucideIcon }> = {
  "manga-workflow":      { label: "VideoKerja流",   icon: Clapperboard },
  "generate-script":     { label: "GenerateSkenario",     icon: ScrollText },
  "generate-storyboard": { label: "GenerateStoryboard",   icon: LayoutGrid },
  "generate-video":      { label: "GenerateVideo",     icon: Film },
  "generate-characters": { label: "GenerateKarakter图",   icon: Users },
  "generate-clues":      { label: "GeneratePetunjuk图",   icon: Search },
  "compose-video":       { label: "KomposisiVideo",     icon: Scissors },
};
